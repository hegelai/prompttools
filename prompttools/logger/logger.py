...
class Logger:
    ...
    def execute_and_add_to_queue(self, *args, **kwargs):
    ...
    def monkey_patch_method(self, method):
        self.original_create = method
        return self.execute_and_add_to_queue
...
class CustomOpenAI(OpenAI):
    def __init__(self, *args, **kwargs):
        ...
        self.logger = Logger()
        self.chat.completions.create = self.logger.monkey_patch_method(self.chat.completions.create)
